...
public class Final {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("PRESTAR MUCHA ATENCION A LOS ERRORES NO FORZADOS COMO LAS CONDICIONES DE LAS EXCEPCIONES");
		...
		agregarBuceos(cba);
			...
			System.out.println("No se pudo agregar Buceo: " + e.getMessage());
		}
	...
	private static void registrarBuceadores(CentroBuceoAvanzado cba) throws Exception {
	...
	private static void registrarBuceadorOpenWater(CentroBuceoAvanzado cba, String nombre, String nacionalidad,
			int edad, int idBuceo) throws Exception {
		
		try {
			Buzo buzo = new BuzoOpenWater(nombre,nacionalidad,edad);
			cba.registrarBuceo(buzo, idBuceo);
			} catch (RuntimeException e) {
	...
	private static void registrarBuceadorAdvanced(CentroBuceoAvanzado cba, String nombre, String nacionalidad, int edad,
			int idBuceo) throws Exception {
	
		try {
		Buzo buzo = new BuzoTecnico(nombre,nacionalidad,edad);
		cba.registrarBuceo(buzo, idBuceo);
		} catch (RuntimeException e) {
			System.out.println(e.getMessage());
		}
	...
	private static void registrarBuceadorTecnico(CentroBuceoAvanzado cba, String nombre, String nacionalidad, int edad,
		...
		try {
		Buzo buzo = new BuzoAdvancedOpenWater(nombre,nacionalidad,edad);
		cba.registrarBuceo(buzo, idBuceo);
		} catch (RuntimeException e) {
			System.out.println(e.getMessage());
		}
