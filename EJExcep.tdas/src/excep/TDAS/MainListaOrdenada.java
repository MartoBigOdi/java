...
public class MainListaOrdenada {
	...
	public static void main(String[] args) {
		...
		porSupDesc.add(new Zona("Zona F", 3, 33.50));
		porSupDesc.add(new Zona("Zona B", 3, 93.05));
		porSupDesc.add(new Zona("Zona A", 3, 108.20));
		porSupDesc.add(new Zona("Zona G", 3, 10.40));
