...
public class MainColas {
	...
	public static void main(String[] args) {
		...
		try {
		System.out.println("--------------- Busqueda de elemento en la COLA devuelve boolean -----------------------");
		System.out.println(buscarElementoColaBoolean(miCola, "Marto"));
		} catch (RuntimeException e) {
			System.out.println("Hubo un error al contar los elementos: " + e.getMessage());
		}
		...
		try {
		System.out.println("--------------- Busqueda de elemento en la COLA devuelve boolean -----------------------");
		System.out.println(buscarElementoColaBoolean(miCola, "Guada"));
		} catch (RuntimeException e) {
			System.out.println("Hubo un error al contar los elementos: " + e.getMessage());
		}
		...
		try {
			System.out.println("--------------- Busqueda de elemento en la COLA devuelve el elemento-----------------------");
			String buscado = buscarElementoCola(miCola, "Guille");
		...
		try {
			System.out.println("--------------- Busqueda de elemento en la COLA devuelve el elemento-----------------------");
			String buscado = buscarElementoCola(miCola, "Camila");
			System.out.println(buscado);
			} catch (RuntimeException e) {
				System.out.println("Hubo un error al contar los elementos: " + e.getMessage());
			}
	...
	//Puedo usar este algortimo para mostrar los elementos
	...
	//Devuelve boolean 
	private static boolean buscarElementoColaBoolean(Cola<String> cola, String nombre) {
	...
	//Devuelve Elemento 
		private static String buscarElementoCola(Cola<String> cola, String nombre) {
